...
# pymarkdown 코드: https://github.com/jackdewinter/pymarkdown/blob/main/pymarkdown/api.py
...
def markdown_validation_tool(file_path: str) -> str:
    ...
    try:
        ...
        scan_result = PyMarkdownApi().scan_path(file_path.rstrip().lstrip()) # https://github.com/jackdewinter/pymarkdown/blob/446fbbf251f5daa150b967b90c72216aeddb73fc/pymarkdown/api.py#L261
